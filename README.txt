...
In example_boards there are some files I have used to test this application

The solver is now only in file so adding it to its own folder feels like adding
